...
A browsable bank of **1,445 olympiad problems** for primary pupils, aimed at Years 3–6 (British programme) / Grades 1–4 (Kazakhstan and former Soviet programmes). Problems are collected from olympiads and sorted by topic, year and difficulty.
...
| `problems.json` | The problem bank — a flat JSON array of 1,445 problems |
| `images/` | 296 figures referenced by problems (grids, clocks, nets, diagrams) |
...
| Field | Meaning |
| --- | --- |
| `n` | Unique problem ID, `1`–`1448` (a few numbers are unused where duplicates were removed) |
| `topic` | One of 42 topics (see below) |
...
**By year group** — Year 3: 324 · Year 4: 385 · Year 5: 386 · Year 6: 342 · Year 1: 8

**By difficulty** — 1: 84 · 2: 371 · 3: 574 · 4: 416

**By source** — FEMO: 879 · Saint Petersburg Mathematical Olympiad: 485 · Altyn Saqa: 81

**By topic**

| Topic | Count |
| --- | ---: |
| Arithmetic word problem – finding the whole or part | 118 |
| Equations | 118 |
| Digit properties / number puzzles | 110 |
| Spatial reasoning | 101 |
| Logic – quantitative bounding | 95 |
| Combinatorics – arrangements / permutations | 67 |
| Sets – inclusion–exclusion | 62 |
| Age problems | 60 |
| Logic – knights and liars | 58 |
| Arithmetic – net displacement | 50 |
| Number sequences & patterns | 48 |
| Iterative / process counting | 47 |
| Counting 2D figures | 46 |
| Cryptarithm | 41 |
| Geometry – perimeter of combined figures | 39 |
| Counting digits | 38 |
...
| Counting consecutive numbers | 22 |
| Geometry – area of combined figures | 22 |
| Clock / time reading | 20 |
| Calendar reasoning | 19 |
| Circular arrangement | 16 |
| LCM / common multiples (cycles) | 8 |
| Arithmetic – computation | 8 |
| Graph colouring | 5 |
| Ciphers / decoding | 4 |
