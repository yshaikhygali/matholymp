...
A browsable bank of **1,302 olympiad problems** for primary pupils, aimed at Years 3–6 (British programme) / Grades 1–4 (Kazakhstan and former Soviet programmes). Problems are collected from olympiads and sorted by topic, year and difficulty.
...
| `problems.json` | The problem bank — a flat JSON array of 1,302 problems |
...
| Field | Meaning |
| --- | --- |
| `n` | Unique problem ID, `1`–`1305` (a few numbers are unused where duplicates were removed) |
...
**By year group** — Year 3: 324 · Year 4: 288 · Year 5: 361 · Year 6: 321 · Year 1: 8

**By difficulty** — 1: 72 · 2: 306 · 3: 523 · 4: 401

**By source** — FEMO: 817 · Saint Petersburg Mathematical Olympiad: 485
...
| Combinatorics – arrangements / permutations | 62 |
| Sets – inclusion–exclusion | 56 |
...
| Cryptarithm | 36 |
| Geometry – perimeter of combined figures | 35 |
